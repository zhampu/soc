 ...
 * You can see the method in use in the `home.php`, `events.php` and `event.php` templates
 * and in the `site/blueprints/sections/events.yml` image query
 * More about models: https://getkirby.com/docs/guide/templates/page-models
 */

class PeerPage extends Page
{
